...
export function getEnrollmentContext() {
  return request("/enrollments/me");
}

export function enrollSection(sectionId) {
  return request("/enrollments/me", {
    method: "POST",
...
export function withdrawEnrollment(enrollmentId) {
  return request(`/enrollments/me/${enrollmentId}`, {
    method: "DELETE",
    body: JSON.stringify({})
  });
}
